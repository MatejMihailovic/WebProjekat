...
public class ArtikalRestController {
    ...
    public ResponseEntity<Artikal> addArtikal(@RequestParam("file") MultipartFile multipartFile, @RequestParam("json") String jsonData, HttpSession session) throws IOException {
